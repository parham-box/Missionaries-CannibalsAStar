...
void setup() {
  ...
  for (int i = 0; i < visitedNodes.size(); i++) {
    ...
    if (i!=0) {
      ...
      //show f(n)
      textSize(9);
      text("f(n)="+visitedNodes.get(i).getCost()+"="+visitedNodes.get(i).getDepth()+"+"+visitedNodes.get(i).getState().getH(), 30+(y*50), 18+(v*50));
      ...
      text("h(n)="+a, 30+(y*50), 40+(v*50));
    } else {
      fill(color(0, 150, 200));
      textSize(9);
      text("f(n)="+visitedNodes.get(i).getCost()+"="+visitedNodes.get(i).getDepth()+"+"+visitedNodes.get(i).getState().getH(), 30, 18+(v*50));
      textSize(14);
      text(visitedNodes.get(i).getState().stateString(), 30, 30+(v*50));
      textSize(9);
      int a = visitedNodes.get(i).getState().getH() == -1 ? 0  :visitedNodes.get(i).getState().getH();
      text("h(n)="+a, 30, 40+(v*50));
    }
  }
